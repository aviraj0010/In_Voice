...
<html>
  ...
  <body >
    ...
    <div class="data-title">
        ...
        font-size: 2rem;  
        padding-left: 20px;">Avirajsinh<br></div>
    <div style="
    display: flex;
    flex-direction: column;
    align-items: flex-start; 
    padding-left: 20px;
    ">App Is Powered By BloggingGrow</div>
    </div>
    ...
    width: 90px;
    margin-right:15px;
        "src="https://imageupload.io/ib/kfPpFeXlYTWQrJU_1699432030.png" />
    </div>
    <hr />
        <hr/>
        ...
        align-items: center;">
            <table style="width:100%; border-collapse: collapse;">
                <tr style="background-color: rgba(179, 44, 203, 0.8); color: white;">
        ...
        <div style="height:auto; padding: 20px;">
            ...
            Bank Name: SBI BANK, BJAVNAGAR<br/>
            Bank Account no : 090395760234<br/>
            Bank IFSC code : SBI6539290<br/>
            </p>
